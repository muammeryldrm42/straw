...
const CAT_FILTERS: { key: string; label: string; cats: string; mode: string; sentiment?: "bullish" | "bearish" }[] = [
  ...
  { key: "feed", label: "news.cat_feed", cats: "", mode: "feed" },
  { key: "news", label: "news.cat_news", cats: "1", mode: "feed" },
  { key: "research", label: "news.cat_research", cats: "2,6", mode: "feed" },
  { key: "macro", label: "news.cat_macro", cats: "5,6", mode: "feed" },
            ...
            <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 8, flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                <span className="mono" style={{ fontSize: 9, color: catColor(n.category), border: `1px solid ${catColor(n.category)}`, borderRadius: 3, padding: "1px 6px", textTransform: "uppercase" }}>
                  {n.category === 2 || n.category === 6 ? t("news.cat_research") : n.category === 5 ? t("news.cat_macro") : n.category === 10 ? t("news.cat_onchain") : t("news.cat_news")}
                </span>
