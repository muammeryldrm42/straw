...
// Son N swing noktasını (high+low karışık, sırayla) çıkar
...
// XABCD harmonic değerlendirici. ratios: {AB, BC, CD, XD} hedef oranlar, tol tolerans
...
export function gartley(c: Candle[]): Signal {
  return harmonicCheck(c, "Gartley", 0.72, [0.5, 0.72], [0.38, 0.89], [1.1, 1.65]);
}
// 2. Bat (AB=0.382-0.5 XA, BC=0.382-0.886, CD=1.618-2.618)
export function bat(c: Candle[]): Signal {
  return harmonicCheck(c, "Bat", 0.72, [0.35, 0.55], [0.38, 0.89], [1.6, 2.65]);
}
...
export function cypher(c: Candle[]): Signal {
  return harmonicCheck(c, "Cypher", 0.7, [0.35, 0.65], [1.1, 1.45], [0.7, 0.86]);
}
