...
// Son iki dip/tepe indeksini bul (basit lokal ekstrem)
...
// Genel divergence dedektörü: regular bullish (fiyat LL, osilatör HL) / bearish (fiyat HH, osilatör LH)
...
// 2. Hidden RSI divergence (continuation)
...
// 10. Multi-oscillator divergence (RSI + MACD agree)
