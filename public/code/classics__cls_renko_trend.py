...
def renkoTrend(c):
    ...
    dir = _d['dir']
    prevDir = _d['prevDir']
    if dir == 1  and  prevDir <= 0:
        return mk(c, i, "long", a, 0.71, "Renko flipped to green bricks (uptrend)")
    if dir == -1  and  prevDir >= 0:
        return mk(c, i, "short", a, 0.71, "Renko flipped to red bricks (downtrend)")
    return make_signal(reason="No Renko flip")
